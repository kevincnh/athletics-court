...
import { CalendarDays, Clock, MapPin, Map as MapIcon, Users, ChevronRight, ChevronLeft, Check } from 'lucide-react';
          ...
          {selectedCourt ? (
            <div className="flex-1 flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-500 ease-out fill-mode-both">
              ...
              <div className="mt-8 pt-6 border-t-2 border-slate-100">
                ...
                >
                  {selectedDate && selectedTime ? 'Confirm Booking' : (!selectedDate ? 'Select a Date First' : 'Select a Time')}
